...
import { ProcessedValueService } from "@/backend/services/ProcessedValueService";
 ...
 * @param {NextApiResponse<ProcessedValue[]>} res - The Next.js API response object.
 * @returns {Promise<void>} - A Promise that resolves once the handling is complete.
 */
export default async function handler(req: NextApiRequest, res: NextApiResponse<ProcessedValue[] | DatabaseError>) {
