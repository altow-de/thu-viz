  ...
  return (
    <div className="mb-4 w-full z-20">
      <Datepicker
        ...
        inputClassName=" relative text-danube-900 border-danube-400 border transition-all duration-300 py-2.5 pl-4 pr-8 w-full rounded-lg tracking-wide font-light text-sm placeholder-gray-custom bg-white disabled:opacity-40 disabled:cursor-not-allowed outline-danube-600"
        minDate={startDate}
        maxDate={new Date()}
        value={selectedDate}
